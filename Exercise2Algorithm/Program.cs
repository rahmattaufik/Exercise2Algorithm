...
namespace Exercise2Algorithm
{
    class Program
    {
        //Array to be searched
        int[] rahmattaufik = new int[20];
        ...
        public void BinarySearch()
        {
            ...
            do
            {
                ...
                while ((item != rahmattaufik[mid]) && (lowerbound <= upperbound))
                {
                    if (item > rahmattaufik[mid])
                        lowerbound = mid + 1;
                    else
                        upperbound = mid - 1;
